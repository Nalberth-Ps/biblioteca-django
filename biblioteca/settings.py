...
SECRET_KEY = 'django-insecure-=fy!_4ox&^#fwl!q3#&!sf-m=^b58o4ztj-x*2k3d48r5%rx#('
...
# Adicione essa configuração para permitir templates de erros personalizados em desenvolvimento
# DEBUG = False
# ALLOWED_HOSTS = ['*']
